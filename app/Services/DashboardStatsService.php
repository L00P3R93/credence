...
=======
    ...
    {
        return $this->getMonthlyLoanBookTotal() - ($this->getNewLoansThisMonth($startDate, $endDate) + $this->getTotalTopUpThisMonth($startDate, $endDate) + $this->getOldLoansThisMonth($startDate, $endDate));
    }
